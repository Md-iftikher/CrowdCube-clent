...
const HomePage = () => {
  ...
  useEffect(() => {
    const fetchRunningCampaigns = async () => {
        try {
            ...
            setRunningCampaigns(data.slice(0, 6));
        } catch (error) {
  ...
  return (
    ...
    >
      ...
      <AboutSection theme={theme} typewriter={Typewriter} />
      {/* <Test></Test> */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {runningCampaigns.length > 0 ? (
            runningCampaigns.map((campaign) => (
              <Fade key={campaign._id} duration={1000}>
                <div
                  ...
                  } p-6 flex flex-col justify-between h-[500px] rounded-lg shadow-lg transition-transform transform hover:scale-105`}
                >
                  <img
            ...
            <p className="text-center text-gray-500">
              No running campaigns available.
            </p>
          )}
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <Slide direction="left">
            ...
            >
              ...
              >
                We are a trusted platform connecting people to impactful
                projects.
              </p>
            </div>
          </Slide>
        ...
        >
          ...
          <Slide direction="down">
            <div>
              ...
              >
                ...
                members <br />
                helping to drive growth & innovation for <br /> businesses
          ...
          <Bounce delay={500}>
            <div className="flex flex-col gap-3">
              ...
              <Link to="/all-campaigns" className="mt-4 px-6 py-3 bg-orange-500 text-white font-bold text-lg rounded-full hover:bg-orange-600 transition">
                Get started
              </Link>
            </div>
          </Bounce>
