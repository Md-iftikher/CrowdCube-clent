...
import { FaHandsHelping } from "react-icons/fa"; // Importing a helping hands icon for the crowdfunding theme
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <FaHandsHelping className="w-10 h-10" /> {/* Using the helping hands icon */}
